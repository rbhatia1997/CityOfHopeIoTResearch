...
const int negXaxis = -1; //changes the axes to be RHR
...
void loop()
{
    ...
    for( int imu = 0; imu < NUM_IMUS; imu++){
        ...
        AccelData[imu][0] = negXaxis * (IMU_List[imu].calcAccel(IMU_List[imu].ax) - accel_Offsets[imu][0]);
        ...
        GyroData[imu][0] = negXaxis * (IMU_List[imu].calcGyro(IMU_List[imu].gx) - gyro_Offsets[imu][0]);
...
//        Serial.print("\t");
//        Serial.print((IMU_List[0].calcMag(IMU_List[0].mz)));
//        Serial.println("\t");
...
//        Serial.print("\t");
//        Serial.print((IMU_List[imu].calcAccel(IMU_List[imu].az)));
//        Serial.print("\t");

//        Serial.print((IMU_List[imu].calcGyro(IMU_List[imu].gx)));
//        Serial.print("\t");
//        Serial.print((IMU_List[imu].calcGyro(IMU_List[imu].gy)));
//        Serial.print("\t");
//        Serial.println((IMU_List[imu].calcGyro(IMU_List[imu].gz)));
